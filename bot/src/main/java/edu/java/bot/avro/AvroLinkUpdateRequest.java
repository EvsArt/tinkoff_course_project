...
@AvroGenerated
public class AvroLinkUpdateRequest extends SpecificRecordBase
     ...
     */
    public AvroLinkUpdateRequest(List<Long> tgChatIds, CharSequence url, CharSequence description) {
    ...
    public void put(int field$, Object value$) {
        switch (field$) {
            case 0:
                tgChatIds = (List<Long>) value$;
                break;
            case 1:
                url = (CharSequence) value$;
                break;
            case 2:
                description = (CharSequence) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
     ...
     */
    public void setTgChatIds(List<Long> value) {
     ...
     */
    @AvroGenerated
    public static class Builder extends SpecificRecordBuilderBase<AvroLinkUpdateRequest>
        implements RecordBuilder<AvroLinkUpdateRequest> {
         ...
         * @return This builder.
         */
        public Builder setTgChatIds(List<Long> value) {
        ...
        public AvroLinkUpdateRequest build() {
            try {
                ...
                record.tgChatIds =
                    fieldSetFlags()[0] ? this.tgChatIds : (List<Long>) defaultValue(fields()[0]);
    ...
    @SuppressWarnings("unchecked")
    private static final DatumWriter<AvroLinkUpdateRequest>
        WRITER$ = (DatumWriter<AvroLinkUpdateRequest>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final DatumReader<AvroLinkUpdateRequest>
        READER$ = (DatumReader<AvroLinkUpdateRequest>) MODEL$.createDatumReader(SCHEMA$);
            ...
            for (int i = 0; i < 3; i++) {
                switch (fieldOrder[i].pos()) {
                    case 0:
                        ...
                        SpecificData.Array<Long> ga0 =
                            (a0 instanceof SpecificData.Array ? (SpecificData.Array<Long>) a0 : null);
                        for (; 0 < size0; size0 = in.arrayNext()) {
                            for (; size0 != 0; size0--) {
                                Long e0 = (ga0 != null ? ga0.peek() : null);
                                e0 = in.readLong();
