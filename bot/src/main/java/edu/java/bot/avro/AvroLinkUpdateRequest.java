...
public class AvroLinkUpdateRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.util.List<Long> tgChatIds;
   ...
   */
  public AvroLinkUpdateRequest(java.util.List<Long> tgChatIds, CharSequence url, CharSequence description) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: tgChatIds = (java.util.List<Long>)value$; break;
   ...
   */
  public java.util.List<Long> getTgChatIds() {
    return tgChatIds;
  }
   ...
   */
  public void setTgChatIds(java.util.List<Long> value) {
   ...
   * @return A new LinkUpdateRequest RecordBuilder
   */
  public static Builder newBuilder(AvroLinkUpdateRequest other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroLinkUpdateRequest>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setTgChatIds(java.util.List<Long> value) {
    ...
    public AvroLinkUpdateRequest build() {
      try {
        ...
        record.tgChatIds = fieldSetFlags()[0] ? this.tgChatIds : (java.util.List<Long>) defaultValue(fields()[0]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<Long> a0 = this.tgChatIds;
      if (a0 == null) {
        a0 = new SpecificData.Array<Long>((int)size0, SCHEMA$.getField("tgChatIds").schema());
        this.tgChatIds = a0;
      } else a0.clear();
      SpecificData.Array<Long> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<Long>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          Long e0 = (ga0 != null ? ga0.peek() : null);
          e0 = in.readLong();
          a0.add(e0);
        }
      }
