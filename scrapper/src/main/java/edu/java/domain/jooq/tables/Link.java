...
public class Link extends TableImpl<LinkRecord> {
    ...
    public final TableField<LinkRecord, OffsetDateTime> LAST_UPDATE_TIME = createField(DSL.name("LAST_UPDATE_TIME"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
