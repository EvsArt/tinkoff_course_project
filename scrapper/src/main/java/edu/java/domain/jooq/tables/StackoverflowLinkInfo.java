...
public class StackoverflowLinkInfo extends TableImpl<StackoverflowLinkInfoRecord> {
    ...
    public final TableField<StackoverflowLinkInfoRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
    ...
    public final TableField<StackoverflowLinkInfoRecord, Integer> ANSWERS_COUNT = createField(DSL.name("ANSWERS_COUNT"), SQLDataType.INTEGER.nullable(false), this, "");
